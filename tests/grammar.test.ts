import { SingleToken, Args, Variable, Identifier, ReturnStatement, FunctionDef, Statement } from "../src/grammar.ts";
...
function testSingleToken() {
    ...
    assertEquals(equalSignBuilt, TokenKind.Assign);
    assertEquals(litIntBuilt, { kind: TokenKind.Lit_Int, value: 2 });
}
